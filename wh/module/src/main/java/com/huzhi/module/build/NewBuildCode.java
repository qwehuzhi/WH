...
/**
 * 标注：目前只能使用NewBuild启动类创建模板
 * BuildCode创建模板无法识别到所有语句
 * 推测原因NewBuild内有一些关键设置，原因不明确
 */
public class NewBuildCode {
...
//		String outputDir = "C://Users/VULCAN/Desktop/new";
        ...
        // 父包路径
        String parentPackage = "com.huzhi.module";
        // 需要去掉的表名前缀
    ...
    public static void generate(String outputDir, String[] tableNames, String url, String userName,
        ...
        focList.add(new FileOutConfig("/templates/mapper.xml.ftl") {
            ...
            public String outputFile(TableInfo tableInfo) {
                // 自定义输入文件名称
                return System.getProperty("user.dir") + "/module/src/main/resources/mybatis/mapper/"
