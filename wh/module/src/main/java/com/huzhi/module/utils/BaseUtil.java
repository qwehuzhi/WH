...
public class BaseUtil {
    ...
    public static String implodeSearchParam(String param1, String param2) {
        String result;
        if (BaseUtil.isEmpty(param1) && BaseUtil.isEmpty(param2)) {
            result = null;
        } else if (!BaseUtil.isEmpty(param1) && !BaseUtil.isEmpty(param2)) {
            result = param1 + "," + param2;
        } else {
            result = BaseUtil.isEmpty(param1) ? param2 : param1;
        }
        return result;
    }
     ...
     * 获取前一天0点的时间戳
     */
    public static Integer getCalendar0Time(){
        Calendar instance = Calendar.getInstance();
        instance.set(instance.get(Calendar.YEAR),instance.get(Calendar.MONTH),instance.get(Calendar.DAY_OF_MONTH)-1,0,0,0);
        long tt = instance.getTime().getTime()/1000;
        return Math.toIntExact(tt);
    }
    /**
     * 获取前一天的YYYY，MM，DD
     */
    public static Map<Integer,String> getCalendar(){
        Calendar calendar = Calendar.getInstance();
        calendar.add(Calendar.DAY_OF_MONTH,-1);
        Date specifyTime = calendar.getTime();
        SimpleDateFormat yy = new SimpleDateFormat("yyyy");
        SimpleDateFormat mm = new SimpleDateFormat("MM");
        SimpleDateFormat dd = new SimpleDateFormat("dd");
        Map<Integer,String> back = new HashMap<>();
        back.put(0,yy.format(specifyTime));
        back.put(1,mm.format(specifyTime));
        back.put(2,dd.format(specifyTime));
        return back;
    }
     ...
     * @return
     */
    public static Map<Integer,String> getYearAndMouth(Integer x){
        Calendar calendar = Calendar.getInstance();
        ...
        Map<Integer,String> back = new HashMap<>();
        back.put(0,yy.format(date));
        back.put(1,mm.format(date));
        return back;
    }
    public static Map<Integer,String[]> getYearAndMouth(Integer... x){
        ...
        for (int i=0 ;i<x.length;i++ ) {
            ...
            Map<Integer, String> back = getYearAndMouth(x[i]);
            base[0]=back.get(0);
            base[1]=back.get(1);
            map.put(x[i],base);
        }
